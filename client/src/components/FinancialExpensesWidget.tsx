...
export default function FinancialExpensesWidget({ selectedLocationId }: FinancialExpensesWidgetProps) {
  ...
  return (
    <Card className="bg-white shadow-sm border border-gray-200" data-testid="financial-expenses-widget">
      <CardHeader className="pb-4">
        ...
        {/* Time Period Filter */}
        <div className="flex flex-wrap gap-2 mt-4" data-testid="expenses-time-filters">
          {timePeriods.map((period) => (
            <Button
              ...
              data-testid={`expenses-filter-${period.id.toLowerCase()}`}
            >
              {period.label}
            </Button>
          ))}
